...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class ApiLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>device</b> with <b>ej.api:device</b> coordinates and
         * with version <b>1.1.0</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDevice() {
            return create("api.device");
        }
        ...
        /**
         * Dependency provider for <b>fs</b> with <b>ej.api:fs</b> coordinates and
         * with version <b>2.1.0</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getFs() {
            return create("api.fs");
        }

        /**
         * Dependency provider for <b>hal</b> with <b>ej.api:hal</b> coordinates and
         * with version <b>1.0.4</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getHal() {
            return create("api.hal");
        }
        ...
        /**
         * Dependency provider for <b>net</b> with <b>ej.api:net</b> coordinates and
         * with version <b>1.1.1</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getNet() {
            return create("api.net");
        }
