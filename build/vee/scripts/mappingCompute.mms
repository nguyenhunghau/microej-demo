# MMS
#
# Copyright 2009-2023 IS2T. All rights reserved.
...
union $Computed $Computed $Label_Types
union $Computed $Computed $Label_ClassNames
union $Computed $Computed $Label_RuntimeTables
...
# BLUETOOTH
substract $Label_BLUETOOTH $Label_BLUETOOTH $Computed
union $Computed $Computed $Label_BLUETOOTH
...
# Security
substract $Label_Security $Label_Security $Computed
union $Computed $Computed $Label_Security

# DTLS
substract $Label_DTLS $Label_DTLS $Computed
union $Computed $Computed $Label_DTLS
...
# Device
substract $Label_Device $Label_Device $Computed
union $Computed $Computed $Label_Device
...
# MicroVG
substract $Label_MicroVG $Label_MicroVG $Computed
union $Computed $Computed $Label_MicroVG
...
# SNI
substract $Label_SNI $Label_SNI $Computed
union $Computed $Computed $Label_SNI
...
# Basictool
substract $Basictool $Basictool $Computed
union $Computed $Computed $Basictool
...
# Service
substract $Service $Service $Computed
union $Computed $Computed $Service
...
# RCommand
substract $RCommand $RCommand $Computed
union $Computed $Computed $RCommand

# Websocket
substract $Websocket $Websocket $Computed
union $Computed $Computed $Websocket

# SNTPClient
substract $SNTPClient $SNTPClient $Computed
union $Computed $Computed $SNTPClient
...
# AllJoyn
substract $AllJoyn $AllJoyn $Computed
union $Computed $Computed $AllJoyn
...
substract LibAddonEclasspath_BASE64 LibAddonEclasspath_BASE64 $Computed
union $Computed $Computed LibAddonEclasspath_BASE64
substract LibAddonEclasspath_FORMATTER LibAddonEclasspath_FORMATTER $Computed
union $Computed $Computed LibAddonEclasspath_FORMATTER
substract LibAddonEclasspath_DATEFORMAT LibAddonEclasspath_DATEFORMAT $Computed
union $Computed $Computed LibAddonEclasspath_DATEFORMAT
substract LibAddonEclasspath_MATH LibAddonEclasspath_MATH $Computed
union $Computed $Computed LibAddonEclasspath_MATH
...
# Device Stack
substract $Label_NativeStackDevice $Label_NativeStackDevice $Computed
union $Computed $Computed $Label_NativeStackDevice

# Security Stack
substract $Label_NativeStackSecurity $Label_NativeStackSecurity $Computed
union $Computed $Computed $Label_NativeStackSecurity

# DTLS Stack
substract $Label_NativeStackDTLS $Label_NativeStackDTLS $Computed
union $Computed $Computed $Label_NativeStackDTLS
...
# WICED
substract $Label_NativeWICED $Label_NativeWICED $Computed
union $Computed $Computed $Label_NativeWICED

# ESP32
substract $Label_NativeESP32_WIFI $Label_NativeESP32_WIFI $Computed
union $Computed $Computed $Label_NativeESP32_WIFI
substract $Label_NativeESP32_BT $Label_NativeESP32_BT $Computed
union $Computed $Computed $Label_NativeESP32_BT
